...
C
      ...
      NAMELIST /ITRPRM/ ITMAX,ITINI,ITSCR,ISTAT,ITSER,ITRES,IVRTX,ITBDY
     ...
     &     ,IMPLXDCMP,IMPLYDCMP,IMPLZDCMP,ICALF,ICFL
      ...
      NAMELIST /DUMPRM/ FRE,AMP,CPHS,KWAV,DUMMYFP1,DUMMYFP2,DUMMYFP3,DUMMYFP4,DUMMYFP5
      NAMELIST /GRIDDM/ NX,NY,NZ,NXPROCS,NYPROCS,NZPROCS
      NAMELIST /IMBPRM/ IPRSDV,IVELRCN,UEXT1,UEXT2,UEXT3,NFLU,NFLP,IDOMY
     $     ,IMB3D,IMBDCMP,IMBOVLP,NFCMAX,NINTMAX,NNTR2D,NNTR3D,ITAGY,IGRDINT,IMLS,IZERO
